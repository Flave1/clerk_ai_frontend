  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">AI Receptionist Dashboard</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">
            Monitor conversations, actions, and system performance in real-time.
          </p>
        </div>
