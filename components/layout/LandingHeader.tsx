...
import { SunIcon, MoonIcon, Bars3Icon, XMarkIcon, MicrophoneIcon } from '@heroicons/react/24/outline';
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            >
              <Link href="/" className="flex items-center gap-0.5 sm:gap-1 relative group">
                <div className="relative flex items-center" 
                  ...
                  <span className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-primary-500 to-accent-500 bg-clip-text text-transparent tracking-tight leading-none ml-0.5 sm:ml-1"
                    style={theme === 'dark' ? { textShadow: '0 0 10px rgba(255, 255, 255, 0.5)' } : undefined}>
                    A
                  </span>
                  <div className="relative h-[1.2em] w-[1.2em] text-xl sm:text-2xl flex items-center justify-center">
